...
async def run_test():
    ...
    try:
        ...
        # -> Type username into the username field, type password into the password field, then click the Login button to attempt login and proceed to the editor page.
