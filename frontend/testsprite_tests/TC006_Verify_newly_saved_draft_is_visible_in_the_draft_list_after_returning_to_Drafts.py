...
async def run_test():
    ...
    try:
        ...
        # -> Click the "Let's Go" button to proceed towards the login or main app page
        ...
        # -> Type 'example@gmail.com' into the username field (index 329).
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Draft list visibility check content.').first).to_be_visible(timeout=3000)
