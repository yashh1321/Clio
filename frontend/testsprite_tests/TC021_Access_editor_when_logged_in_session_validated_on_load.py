...
async def run_test():
    ...
    try:
        ...
        # -> Input username into index 158, input password into index 159, click login (index 160), then navigate explicitly to http://localhost:3000/editor
        ...
        # -> Navigate explicitly to http://localhost:3000/editor (per test requirement) to check whether the authenticated session grants access to the protected editor route.
