...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Let's Go' button (index 68) to proceed towards the login or next page.
        ...
        # -> Fill username (index 345) and password (index 346) and click the Login button (index 347).
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Save Draft').first).to_be_visible(timeout=3000)
