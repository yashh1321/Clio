...
async def run_test():
    ...
    try:
        ...
        # -> Type the student username into the username field and password into the password field, then click Login.
        ...
        # -> Click the 'Register' link (index 182) to create a new account because login failed; immediate action: click element index 182.
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('text=Confirm submission').first).to_be_visible(timeout=3000)
