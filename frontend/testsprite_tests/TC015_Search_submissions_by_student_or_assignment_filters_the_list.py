...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (use exact path appended to base URL)
        await page.goto("http://localhost:3000/login", wait_until="commit", timeout=10000)
        
        # -> Enter credentials (username/password) and click the Login button to access the dashboard.
        ...
        await expect(frame.locator('text=No submissions').first).to_be_visible(timeout=3000)
