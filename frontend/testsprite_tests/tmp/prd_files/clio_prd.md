...
*Note: The legacy Python FastAPI/Streamlit backend has been fully deprecated in favor of Next.js server-side API routes interacting securely with Supabase.*

## 3. System Architecture
The system consists of a Next.js full-stack application communicating directly with a Supabase PostgreSQL database.
...
- **Backend (Next.js APIs)** processes submissions, calculates scores, handles secure authentication (JWT), and securely bypasses RLS using the Service Role Key for database operations.
